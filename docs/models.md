...
| Tiêu chí | Item-CF | Item2Vec | Metapath2Vec | CB Filter | Ensemble (w/o CB) | Ensemble + CB |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
...
Với mỗi model cần đánh giá (Item-CF, Item2Vec, Metapath2Vec, Ensemble+CB), mẫu được chọn theo tỷ lệ:
...
| `model_name` | str | Tên model tạo ra mẫu này (`item_cf`, `item2vec`, `metapath2vec`, `ensemble_cb`) |
