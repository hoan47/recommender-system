...
```
                    ...
                    ▼                    ▼                    ▼
          ┌──────────────────┐  ┌──────────────────┐  ┌──────────────┐
           │ Ochiai + Conf    │  │ Item2Vec         │  │ Metapath2Vec │
           │ (pairwise score  │  │ (Word2Vec        │  │ (IKG         │
...
| Tiêu chí | Ochiai+Conf | Item2Vec | Metapath2Vec | Assoc. Rules | CB Filter | Ensemble (w/o CB) | Ensemble + CB |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **Vai trò** | Model gợi ý | Model gợi ý | Model gợi ý | Baseline | Bộ lọc hậu xử lý | Ensemble thuần (O+I+MW) | Ensemble + Filter |
...
Với mỗi model cần đánh giá (Ochiai, Item2Vec, Metapath2Vec, Association Rules, Ensemble+CB), mẫu được chọn theo tỷ lệ:
...
| `model_name` | str | Tên model tạo ra mẫu này (`ochiai`, `item2vec`, `metapath2vec`, `assoc_rules`, `ensemble_cb`) |
