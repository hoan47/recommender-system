...
Chạy riêng: python scripts/model/02_cb_filter.py
Yêu cầu: scripts/model/01_load_data.py đã chạy
Output: models/cb_filter/ (tfidf_vectors.npz, count_vectors.npz)
"""
import json
import os
import sys
...
if not os.path.exists(products_path):
    ...
    print("Yêu cầu: chạy scripts/model/01_load_data.py trước")
    sys.exit(1)
...
# Lưu product_id_to_idx để 06_ensemble.py load đúng mapping
