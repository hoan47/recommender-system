"""
Bước 7: Đánh giá các model gợi ý mua kèm dùng ground truth từ LLM (Gemini).
...
Yêu cầu:
   - Đã train xong tất cả model (scripts/model/01 → 06)
...
def main():
    print("=" * 60)
    print("BƯỚC 7: ĐÁNH GIÁ MODEL BẰNG LLM GROUND TRUTH")
    print("=" * 60)
